    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-pink-200 to-white bg-clip-text text-transparent">
            Analysez vos Backlinks
          </h1>
          
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Découvrez votre profil de backlinks, identifiez les opportunités et 
            surveillez la qualité de vos liens entrants pour booster votre autorité.
          </p>
      ...
      <div className="pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ModernSection title="Outils d'Analyse de Backlinks">
            <ModernGrid>
...
export default AnalyseBacklinks;
